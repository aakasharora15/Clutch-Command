// Clutch Command — Homepage Concept, ported to React.
// Assets expected in /public: /images/tennis-court.jpg, /audio/heartbeat.mp3
// Fonts: load Poppins (300/400/500/600) via <link> in your document head, or next/font.
// Import index.css alongside this component (e.g. `import './index.css'` in Next.js,
// or via your global stylesheet import).
...
const TOTAL_MS = 3200; // hard cap on the whole intro
...
function PressureIntro({ onDone }) {
  const introRef = useRef(null);
  const traceRef = useRef(null);
  const scanRef = useRef(null);
  const pressureRef = useRef(null);
  const audioRef = useRef(null);
  const [phase, setPhase] = useState('idle'); // idle | pulsing | reveal | gone
  ...
  function run() {
    ...
    let actx, analyser, dataArr, gainNode;
    try {
    ...
    function frame(ts) {
      ...
      // sweep the ECG trace across the readout in lockstep with the audio's own clock
      ...
      // real beat-sync: read live amplitude off the actual recording, pulse on genuine peaks
      if (analyser) {
    ...
    if (playPromise && playPromise.catch) {
      playPromise.catch(() => { /* autoplay blocked — visual still runs on its own clock */ });
    }
    ...
    <>
      ...
      <nav>
        <div className="nav-inner">
          <div className="logo">clutch</div>
          <ul className="nav-links">
            <li><a href="#programs">Product</a></li>
            <li><a href="#coaches">Coaches</a></li>
            <li><a href="#moments">Academy</a></li>
            <li><a href="#offer">Pricing</a></li>
            <li><a href="#tips">Blog</a></li>
          </ul>
          <a href="#offer" className="nav-cta">Join Now</a>
        </div>
      </nav>
      ...
      <div className="programs-shell" id="programs" style={{ marginTop: 110 }}>
      ...
      <section className="moments" id="moments">
        ...
        <div className="wrap" style={{ overflow: 'visible' }}>
          ...
          <div className="moments-cta"><a href="#" className="pill">View Gallery</a></div>
        </div>
      </section>
      ...
      <section className="tips" id="tips">
        <div className="wrap tips-grid">
          <div className="tips-left">
            ...
            <a href="#" className="pill">View Blog</a>
          </div>
          <div>
      ...
      <footer id="offer">
        <div className="wrap">
          <div className="foot-top">
            <div>
              <div className="foot-head">Train Smart.<br />Win Clutch.</div>
              <ul className="socials">
                <li><b>Facebook</b><span>f</span></li>
                <li><b>Instagram</b><span>◎</span></li>
                <li><b>LinkedIn</b><span>in</span></li>
                <li><b>X</b><span>x</span></li>
              </ul>
            </div>
            <div className="foot-right">
              <p>Clutch Command Is A Modern Training System Focused On Pressure Performance — Built With Grand Slam Coaches For Players Who Want To Win The Close Ones.</p>
              <a href="#" className="pill">Start Your Journey</a>
          ...
          <div className="foot-wordmark"><span>clutch</span></div>
          <p className="credit">Homepage concept — internal design reference for the Clutch Command build.</p>
        </div>
      </footer>
    </>
  );
